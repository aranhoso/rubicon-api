...
**Updated `tests\Gui.Rubicon.FunctionalTests\Gui.Rubicon.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Gui.Rubicon.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Gui.Rubicon.FunctionalTests\Gui.Rubicon.FunctionalTests.csproj
```
