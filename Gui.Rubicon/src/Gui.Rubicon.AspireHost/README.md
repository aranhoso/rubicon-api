...
1. Set `Gui.Rubicon.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../Gui.Rubicon.Infrastructure/Gui.Rubicon.Infrastructure.csproj -s Gui.Rubicon.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../Gui.Rubicon.Infrastructure/Gui.Rubicon.Infrastructure.csproj -s Gui.Rubicon.Web.csproj
```
